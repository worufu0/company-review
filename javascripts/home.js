var pageName = "homepage",
  headerClass = ($isMobile = !!$(".mobile_search")[0])
    ? ".main-header-menu"
    : ".main-menu",
  positionOfCover =
        ...
        var sliderWrap = $("#" + sliderId),
          sliderObj = sliderWrap.lightSlider({
            ...
            responsive: [
              {
                breakpoint: 900,
                settings: { item: 2, slideMove: 2, speed: 200 },
              },
              {
                breakpoint: 600,
                settings: { item: 1.2, slideMove: 1, speed: 100 },
              },
            ],
            onBeforeStart: function (el) {},
            onSliderLoad: function (el) {
              sliderWrap.removeClass("slider_default"),
                el.getTotalSlideCount() < 3 &&
                  sliderWrap
                    .parent()
                    .parent()
                    .siblings(".slider_next")
                    .addClass("hidden_control");
            },
            onBeforeSlide: function (el) {},
            onAfterSlide: function (el) {
              1 < el.getCurrentSlideCount() &&
                sliderWrap
                  .parent()
                  .parent()
                  .siblings(".slider_prev")
                  .removeClass("hidden_control"),
                1 == el.getCurrentSlideCount() &&
                  sliderWrap
                    .parent()
                    .parent()
    ...
    $(".cover_image_wrap").position().top +
      $(".cover_image_wrap").outerHeight(!0) -
      $(headerClass).outerHeight(!0));
...
$isMobile && (positionOfCover -= 24),
  $(document).scroll(function (e) {
    ...
    positionOfCover <= scrollPos
      ? ($(headerClass).removeClass("blue-menu"),
        $isMobile && $(".search").show())
      : ($(headerClass).addClass("blue-menu"),
        $isMobile && $(".search").hide());
  }),
